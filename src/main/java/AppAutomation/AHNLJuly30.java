...
// new lt://APP10160541811717764121977817
            capabilities.setCapability("app", "lt://APP10160502001722329640214898");
//capabilities.setCapability("app", "lt://APP1016025931715779582402477");
            ...
            capabilities.setCapability("build", "android-StartActivity-not-working");
...
////
        ...
        threadLocalDriver.get().terminateApp("com.icemobile.albertheijn.debug");

        threadLocalDriver.get().startActivity(new Activity("com.icemobile.albertheijn.debug", "nl.ah.appie.app.splash.DeepLinkActivity"));

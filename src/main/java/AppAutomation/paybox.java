...
public class paybox {
    public static String userName = System.getenv("LT_USERNAME") == null ? "mohammadk" // Add username here
            : System.getenv("LT_USERNAME");
    public static String accessKey = System.getenv("LT_ACCESS_KEY") == null ? "rakcBoBYHiy8BW7osVi4N1LGYjgJhRfAwvL1pPUvwCA1wfNChd" // Add accessKey here
    ...
    public static void main(String args[]) throws MalformedURLException, InterruptedException {
        ...
        try {
            ...
            capabilities.setCapability("deviceName", "Galaxy Note20");
            ...
            driver = new AppiumDriver(
                    new URL("http://" + userName + ":" + accessKey + "@mobile-hub.lambdatest.com/wd/hub"),
                    capabilities);
